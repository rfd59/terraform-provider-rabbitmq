...
func (Acceptance) PreCheck(t *testing.T) {
...
func (Acceptance) ValidFeature(miniVersion string) bool {
	return semver.Compare("v"+TestAcc.Version, "v"+miniVersion) >= 0
}

func (Acceptance) Client(t *testing.T) *rabbithole.Client {
