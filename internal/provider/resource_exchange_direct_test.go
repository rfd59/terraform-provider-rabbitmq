...
func TestAccExchangeDirect_Required(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
...
func TestAccExchangeDirect_Optional(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:              data.RandomString(),
...
func TestAccExchangeDirect_ArgumentsString(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeDirect_ArgumentsNumeric(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeDirect_ArgumentsBoolean(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeDirect_ArgumentTypeValidation(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name: data.RandomString(),
...
func TestAccExchangeDirect_ErrorVhostNotExist(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:  data.RandomString(),
...
func TestAccExchangeDirect_AlredayExist(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeDirect_ImportRequired(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_direct", "test")
	r := acceptance_test.ExchangeDirectResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
