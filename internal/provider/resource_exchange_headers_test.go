...
func TestAccExchangeHeaders_Required(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
...
func TestAccExchangeHeaders_Optional(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:              data.RandomString(),
...
func TestAccExchangeHeaders_ArgumentsString(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeHeaders_ArgumentsNumeric(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeHeaders_ArgumentsBoolean(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeHeaders_ArgumentTypeValidation(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name: data.RandomString(),
...
func TestAccExchangeHeaders_ErrorVhostNotExist(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:  data.RandomString(),
...
func TestAccExchangeHeaders_AlredayExist(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeHeaders_ImportRequired(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_headers", "test")
	r := acceptance_test.ExchangeHeadersResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
