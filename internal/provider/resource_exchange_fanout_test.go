...
func TestAccExchangeFanout_Required(t *testing.T) {
...
func TestAccExchangeFanout_Optional(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:              data.RandomString(),
...
func TestAccExchangeFanout_ArgumentsString(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeFanout_ArgumentsNumeric(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeFanout_ArgumentsBoolean(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeFanout_ArgumentTypeValidation(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name: data.RandomString(),
...
func TestAccExchangeFanout_ErrorVhostNotExist(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:  data.RandomString(),
...
func TestAccExchangeFanout_AlredayExist(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
...
func TestAccExchangeFanout_ImportRequired(t *testing.T) {
	data := acceptance_test.BuildTestData("rabbitmq_exchange_fanout", "test")
	r := acceptance_test.ExchangeFanoutResource{
		ExchangeResource: acceptance_test.ExchangeResource{
			Name:    data.RandomString(),
